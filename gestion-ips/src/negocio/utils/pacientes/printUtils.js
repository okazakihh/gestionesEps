...
export const printHistoriaClinica = async (consultas, historiaClinica, patient, patientData) => {
  ...
  allConsultas.push({
    ...
    diagnosticos: (historiaData && historiaData.diagnostico?.diagnosticos) || (historiaData && historiaData.diagnosticoTratamiento?.diagnosticos) || (historiaData && historiaData.diagnosticoPlan?.diagnosticos) || 'N/A',
    planTratamiento: (historiaData && historiaData.diagnostico?.plan?.conducta) || (historiaData && historiaData.diagnosticoTratamiento?.planTratamiento) || (historiaData && historiaData.diagnosticoPlan?.planTratamiento) || 'N/A',
