...
import GestionPacientesComponent from '../../components/pacientes/GestionPacientesComponent';
import HistoriasClinicasComponent from '../../components/pacientes/HistoriasClinicasComponent';
import ConsultasMedicasComponent from '../../components/pacientes/ConsultasMedicasComponent';
import DocumentosMedicosComponent from '../../components/pacientes/DocumentosMedicosComponent';

type TabType = 'pacientes' | 'historias' | 'consultas' | 'documentos';
