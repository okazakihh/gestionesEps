...
// Funci√≥n de utilidad movida fuera del componente para reutilizaci√≥n y rendimiento.
      ...
      <Stack gap="lg">
            ...
            {loadingPatients ? (
                      ...
                      <Group justify="space-between" wrap="nowrap">
                        <Group gap="md" style={{ flex: 1, minWidth: 0 }}>
                          ...
                          <Stack gap={4} style={{ flex: 1, minWidth: 0 }}>
                            ...
                            <Group gap="md">
                              <Text size="xs" c="dimmed">ü"Ñ {patient.tipoDocumento} {patient.numeroDocumento}</Text>
                              <Text size="xs" c="dimmed">ü"û {patientData.telefono !== 'N/A' ? patientData.telefono : 'Sin tel√©fono'}</Text>
                            </Group>
                          </Stack>
                        </Group>
                        {isSelected && (
              ...
              <Stack align="center" justify="center" py="xl">
                ...
                <Text size="sm" c="dimmed" ta="center">
                  {searchTerm ? 'No se encontraron pacientes que coincidan con la b√∫squeda' : 'No hay pacientes disponibles'}
                </Text>
              </Stack>
            )}
          </ScrollArea>
        ...
        {selectedSlot && (
          <Paper p="md" radius="md" withBorder style={{ backgroundColor: 'var(--mantine-color-blue-0)' }}>
            <Stack gap="sm">
              <Title order={5} size="h6" c="blue.9">Informaci√≥n de la Cita</Title>
              <Stack gap={4}>
                ...
                {selectedDoctor && (
                  <Text size="sm" c="blue.9">
                    <Text component="span" fw={500}>M√©dico:</Text> {selectedDoctor.nombreCompleto || ''}
                  </Text>
                )}
              </Stack>
            </Stack>
